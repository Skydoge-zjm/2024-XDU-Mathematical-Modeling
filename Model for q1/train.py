...
for epoch in range(epochs):
    ...
    with torch.no_grad():
        ...
        if epoch == epochs - 1:
            ...
            plt.title('Part of True and Predicted for 2020-7')
            ...
            plt.savefig('True-Predict.png', format='png', dpi=500)
            print("saved figure True-Predict.png")

            torch.save(model.state_dict(), './model/model_state_dict_2.pth')
...
plt.legend(loc='upper right')
plt.grid(True, linestyle='--', alpha=0.5)
plt.savefig('loss_plot.png', format='png', dpi=500)
