...
state_dict = torch.load('./model/model_state_dict_AT.pth', map_location=device)
...
copy_file = './data/q4/lstm_predict.xlsx'
outcome = './data/q4/lstm_predict_outcome.xlsx'

df = pd.read_excel(copy_file)

for idx, val in zip(indices, values):
    df.loc[df.index[idx], 'AT2'] = val
